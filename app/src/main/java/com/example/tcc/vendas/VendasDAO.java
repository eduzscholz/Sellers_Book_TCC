...
public class VendasDAO extends SQLiteOpenHelper {
    ...
    private static final String COL_ID = "vendaID";
    private static final String COL_DATA_COMPRA = "dataCompra";
    private static final String COL_ID_CLIENTE= "clienteID";
    public static final String COL_DATA_PAGAMENTO = "dataPagamento";
    private static final String COL_PREVISAO = "previsaoPagamento";
    ...
    public ArrayList<Venda> readManyVenda(String nome){
        ArrayList<Venda> vendaArrayList = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
